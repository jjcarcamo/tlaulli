 ...
 *
*/
(function(c){c.cluetip={version:"1.2.4",template:'<div><div class="cluetip-outer"><h3 class="cluetip-title ui-widget-header ui-cluetip-header"></h3><div class="cluetip-inner ui-widget-content ui-cluetip-content"></div></div><div class="cluetip-extra"></div><div class="cluetip-arrows ui-state-default"></div></div>',setup:{insertionType:"appendTo",insertionElement:"body"},defaults:{multiple:false,height:"auto",cluezIndex:97,positionBy:"auto",topOffset:15,leftOffset:15,local:false,localPrefix:null,
...
U=+a.cluezIndex;d.data("cluetip",{title:g.title,zIndex:U,selector:ba});if(!m&&!a.splitTitle&&!j)return true;if(a.local&&a.localPrefix)m=a.localPrefix+m;a.local&&a.hideLocal&&m&&c(m+":first").hide();var s=parseInt(a.topOffset,10),B=parseInt(a.leftOffset,10),C,ca,W=isNaN(parseInt(a.height,10))?"auto":/\D/g.test(a.height)?a.height:a.height+"px",X,v,w,J,Y,da=parseInt(a.width,10),n=da+la+a.dropShadowSteps,F=this.offsetWidth,x,k,o,K,G,y=a.attribute!="title"?d.attrProp(a.titleAttribute)||"":"";if(a.splitTitle){G=
